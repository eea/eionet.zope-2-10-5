...
ENV WEBSITE=/var/local/website PDIR=/var/local/python244
...
RUN \
    ...
    && cd /opt/Zope-2.10.5-final && ./configure --prefix=/var/local/zope2105 --with-python=$PDIR/bin/python && make && make install
